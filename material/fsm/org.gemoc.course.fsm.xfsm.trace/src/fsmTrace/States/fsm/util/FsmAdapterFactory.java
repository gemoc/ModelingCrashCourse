...
public class FsmAdapterFactory extends AdapterFactoryImpl {
	...
	protected FsmSwitch<Adapter> modelSwitch =
		new FsmSwitch<Adapter>() {
			@Override
			public Adapter caseTracedFiniteStateMachine(TracedFiniteStateMachine object) {
				return createTracedFiniteStateMachineAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.States.fsm.TracedFiniteStateMachine <em>Traced Finite State Machine</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedFiniteStateMachineAdapter() {
		return null;
	}
