...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StepsPackage.FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL: {
				Fsm_FiniteStateMachine_InitializeModel fsm_FiniteStateMachine_InitializeModel = (Fsm_FiniteStateMachine_InitializeModel)theEObject;
				T result = caseFsm_FiniteStateMachine_InitializeModel(fsm_FiniteStateMachine_InitializeModel);
				if (result == null) result = caseSpecificStep(fsm_FiniteStateMachine_InitializeModel);
				if (result == null) result = caseSmallStep(fsm_FiniteStateMachine_InitializeModel);
				if (result == null) result = caseStep(fsm_FiniteStateMachine_InitializeModel);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Fsm Finite State Machine Initialize Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Fsm Finite State Machine Initialize Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFsm_FiniteStateMachine_InitializeModel(Fsm_FiniteStateMachine_InitializeModel object) {
		return null;
	}
