...
public class StepsAdapterFactory extends AdapterFactoryImpl {
	...
	protected StepsSwitch<Adapter> modelSwitch =
		new StepsSwitch<Adapter>() {
			@Override
			public Adapter caseFsm_FiniteStateMachine_InitializeModel(Fsm_FiniteStateMachine_InitializeModel object) {
				return createFsm_FiniteStateMachine_InitializeModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.Steps.Fsm_FiniteStateMachine_InitializeModel <em>Fsm Finite State Machine Initialize Model</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFsm_FiniteStateMachine_InitializeModelAdapter() {
		return null;
	}
