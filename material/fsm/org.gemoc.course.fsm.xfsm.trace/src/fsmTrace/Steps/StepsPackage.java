...
public interface StepsPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link fsmTrace.Steps.impl.Fsm_FiniteStateMachine_InitializeModelImpl <em>Fsm Finite State Machine Initialize Model</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fsmTrace.Steps.impl.Fsm_FiniteStateMachine_InitializeModelImpl
	 * @see fsmTrace.Steps.impl.StepsPackageImpl#getFsm_FiniteStateMachine_InitializeModel()
	 * @generated
	 */
	int FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL = 0;
	 ...
	 * @ordered
	 */
	int FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL__MSEOCCURRENCE = SPECIFIC_STEP__MSEOCCURRENCE;
	 ...
	 * @ordered
	 */
	int FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL__ENDING_STATE = SPECIFIC_STEP__ENDING_STATE;
	 ...
	 * @ordered
	 */
	int FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL__STARTING_STATE = SPECIFIC_STEP__STARTING_STATE;

	/**
	 * The number of structural features of the '<em>Fsm Finite State Machine Initialize Model</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL_FEATURE_COUNT = SPECIFIC_STEP_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link fsmTrace.Steps.Fsm_FiniteStateMachine_InitializeModel <em>Fsm Finite State Machine Initialize Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Fsm Finite State Machine Initialize Model</em>'.
	 * @see fsmTrace.Steps.Fsm_FiniteStateMachine_InitializeModel
	 * @generated
	 */
	EClass getFsm_FiniteStateMachine_InitializeModel();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link fsmTrace.Steps.impl.Fsm_FiniteStateMachine_InitializeModelImpl <em>Fsm Finite State Machine Initialize Model</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fsmTrace.Steps.impl.Fsm_FiniteStateMachine_InitializeModelImpl
		 * @see fsmTrace.Steps.impl.StepsPackageImpl#getFsm_FiniteStateMachine_InitializeModel()
		 * @generated
		 */
		EClass FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL = eINSTANCE.getFsm_FiniteStateMachine_InitializeModel();
