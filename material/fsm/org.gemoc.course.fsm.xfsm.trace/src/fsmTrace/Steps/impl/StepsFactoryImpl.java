...
public class StepsFactoryImpl extends EFactoryImpl implements StepsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case StepsPackage.FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL: return createFsm_FiniteStateMachine_InitializeModel();
	 ...
	 * @generated
	 */
	public Fsm_FiniteStateMachine_InitializeModel createFsm_FiniteStateMachine_InitializeModel() {
		Fsm_FiniteStateMachine_InitializeModelImpl fsm_FiniteStateMachine_InitializeModel = new Fsm_FiniteStateMachine_InitializeModelImpl();
		return fsm_FiniteStateMachine_InitializeModel;
	}
