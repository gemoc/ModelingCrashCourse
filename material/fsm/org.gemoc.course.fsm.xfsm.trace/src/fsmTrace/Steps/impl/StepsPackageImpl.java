...
public class StepsPackageImpl extends EPackageImpl implements StepsPackage {
	 ...
	 * @generated
	 */
	private EClass fsm_FiniteStateMachine_InitializeModelEClass = null;
	 ...
	 * @generated
	 */
	public EClass getFsm_FiniteStateMachine_InitializeModel() {
		return fsm_FiniteStateMachine_InitializeModelEClass;
	}
	...
	public void createPackageContents() {
		...
		fsm_FiniteStateMachine_InitializeModelEClass = createEClass(FSM_FINITE_STATE_MACHINE_INITIALIZE_MODEL);
	...
	public void initializePackageContents() {
		...
		fsm_FiniteStateMachine_InitializeModelEClass.getESuperTypes().add(this.getSpecificStep());
		fsm_FiniteStateMachine_InitializeModelEClass.getESuperTypes().add(theTracePackage.getSmallStep());
		...
		initEClass(fsm_FiniteStateMachine_InitializeModelEClass, Fsm_FiniteStateMachine_InitializeModel.class, "Fsm_FiniteStateMachine_InitializeModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(fsm_FiniteStateMachine_InitializeModelEClass, theFsmPackage_1.getTracedFiniteStateMachine(), "getCaller", 1, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(fsm_State_StepEClass, Fsm_State_Step.class, "Fsm_State_Step", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(fsm_State_StepEClass, theFsmPackage.getState(), "getCaller", 1, 1, IS_UNIQUE, IS_ORDERED);
