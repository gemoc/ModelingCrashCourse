...
public interface StepsFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Fsm Finite State Machine Initialize Model</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Fsm Finite State Machine Initialize Model</em>'.
	 * @generated
	 */
	Fsm_FiniteStateMachine_InitializeModel createFsm_FiniteStateMachine_InitializeModel();
