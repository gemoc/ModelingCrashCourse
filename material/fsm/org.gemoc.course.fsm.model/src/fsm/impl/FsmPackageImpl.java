...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (finiteStateMachineEClass, 
		   source, 
		   new String[] {
			 "constraints", "uniqueStateNames"
		   });	
		addAnnotation
		  (stateEClass, 
		   source, 
		   new String[] {
			 "constraints", "uniqueStateNameInFSM"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (finiteStateMachineEClass, 
		   source, 
		   new String[] {
			 "uniqueStateNames", "self.states->forAll(s1, s2| s1 <> s2 implies s1.name <> s2.name)"
		   });	
		addAnnotation
		  (stateEClass, 
		   source, 
		   new String[] {
			 "uniqueStateNameInFSM", "self.oclContainer.oclAsType(FiniteStateMachine).states->forAll(s1| s1 <> self implies s1.name <> self.name)"
		   });
	}
